...
/**
 * Provides an interface to the map-renderer, affording some control over its execution.
 * 
 * @author snowjak88
 *
 */
public interface MapRendererStatus {
	...
	/**
	 * Request that the given map-cell be re-drawn on the next frame.
	 * 
	 * @param cellX
	 * @param cellY
	 */
	public void requestRedraw(int cellX, int cellY);

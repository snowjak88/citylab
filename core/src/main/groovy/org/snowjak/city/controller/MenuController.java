...
public class MenuController implements ViewRenderer {
	...
	/**
	 * Asset-annotated files will be found and automatically loaded by the
	 * AssetsService.
	 */
	...
	public void render(final Stage stage, final float delta) {
		...
		// As a proof of concept that you can pair custom logic with Autumn MVC views,
		// this class implements
		// ViewRenderer and handles view rendering manually. It renders libGDX logo
		// before drawing the stage.
		stage.act(delta);

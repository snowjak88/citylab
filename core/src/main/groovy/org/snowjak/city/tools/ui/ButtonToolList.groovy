...
class ButtonToolList extends Window {
	...
	private static final Color TRANSPARENT_COLOR = Color.rgba8888(1, 1, 1, 0)
	...
	public ButtonToolList(Skin skin, GameAssetService assetService) {
		
		super("", skin)
		
		this.assetService = assetService
		
		buttonMask = assetService.get("ui/buttons/button_mask.png")
		buttonHighlight = assetService.get("ui/buttons/button_mask_highlight.png")
	...
	public static class ButtonTreeNode extends Tree.Node<ButtonTreeNode, ModelNode, Button> {
	}
}

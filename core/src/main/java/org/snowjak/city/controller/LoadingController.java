...
/**
 * Thanks to View annotation, this class will be automatically found and
 * initiated.
 *
 * This is the first application's view, shown right after the application
 * starts. It will hide after all assests are loaded.
 */
@View(value = "ui/templates/loading.lml", first = true)
public class LoadingController implements ViewRenderer {
	
	/**
	 * Will be injected automatically. Manages assets. Used to display loading
	 * progress.
	 */
	@Inject
	...
	// Since this class implements ViewRenderer, it can modify the way its view is
	// drawn. Additionally to drawing the

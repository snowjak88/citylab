...
//
// Specifies whether the next tile will be "transparent" -- i.e., whether it covers
// the whole grid-cell (false) or shows part of what is "under" it (true).
//
// (Default: false)
transparent = false
...
//
ext.water = [:]
ext.water.waterAsLayer = true

ext.roads = [:]
ext.roads.roadsAsLayer = true
